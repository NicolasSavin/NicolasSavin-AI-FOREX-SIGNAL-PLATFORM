...
class SignalCard(BaseModel):
    ...
    signal_time_utc: datetime = Field(default_factory=lambda: datetime.now(timezone.utc))
    ...
    signal_datetime: datetime = Field(default_factory=lambda: datetime.now(timezone.utc), alias="signalDateTime")
