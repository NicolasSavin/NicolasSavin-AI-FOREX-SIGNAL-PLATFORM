...
class KnowledgeGraphDiagnostics(BaseModel):
    catalog_items_scanned: int = 0; review_files_scanned: int = 0; reviews_scanned: int = 0; reviews_loaded: int = 0; reviews_indexed: int = 0; orphan_reviews_indexed: int = 0; reviews_missing: int = 0; malformed_reviews: int = 0; symbols_found: int = 0; trade_ideas_found: int = 0; authors: int = 0; committee_entries: int = 0; conflicts: int = 0; build_time_ms: int = 0; generated_at: str | None = None; last_built_at: str | None = None; cache_age_seconds: float | None = None; cache_hit: bool = False; cache_empty: bool = False; last_invalidation_reason: str | None = None; errors: int = 0
