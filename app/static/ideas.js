...
function getAiSourceMeta(idea) {
  ...
  if (/grok|openrouter|model|llm/.test(source) && !isFallback) return { label: "Grok", tone: "grok", line: "Generated by Grok via OpenRouter" };
  if (isFallback) return { label: "Fallback Engine", tone: "fallback", line: "Generated by fallback logic (LLM unavailable)" };
  return { label: "Rule Engine", tone: "rule", line: "Generated by fallback logic (LLM unavailable)" };
}
