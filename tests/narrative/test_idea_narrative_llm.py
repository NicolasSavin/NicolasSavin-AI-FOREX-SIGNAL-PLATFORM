...
def _ok_content() -> str:
    return (
        ...
        '"unified_narrative":"Цена у зоны после sweep ликвидности. BOS подтверждает перевес покупателей. Это повышает шанс импульса вверх. Работаем только при подтверждении входа. При сломе структуры сценарий отменяется.",'
